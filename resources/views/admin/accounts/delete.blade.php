    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ $account->name }}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('admin.accounts.destroy', $account->id)}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">are you sure to delete ({{ $account->name }})?</h5>
